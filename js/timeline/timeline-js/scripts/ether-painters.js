...
Timeline.EtherIntervalMarkerLayout = function (timeline, band, theme, align, showLine) {
    ...
    this.createIntervalMarker = function (date, labeller, unit, markerDiv, lineDiv) {
        ...
        if (showLine && unit != Timeline.DateTime.WEEK) {
            ...
            if (lineTheme.opacity < 1.0) {
                divLine.style.opacity = lineTheme.opacity;
            }
        ...
        if (unit == Timeline.DateTime.WEEK) {
            ...
            if (weekendTheme.opacity < 1.0) {
                divWeekend.style.opacity = weekendTheme.opacity;
            }
...
Timeline.EtherHighlight = function (timeline, band, theme, backgroundLayer) {
    ...
    this._createHighlightDiv = function () {
        if (this._highlightDiv == null) {
            ...
            if (opacity < 1.0) {
                this._highlightDiv.style.opacity = opacity;
            }
