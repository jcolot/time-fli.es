...
jQuery(G.iconElmtData.elmt).on("mousedown",D);
jQuery(G.labelElmtData.elmt).on("mousedown",D);
...
jQuery(I.iconElmtData.elmt).on("mousedown",F);
jQuery(I.labelElmtData.elmt).on("mousedown",F);
for(var C=0;
C<J.length;
...
jQuery(s).on("mousedown",x);
jQuery(v.elmt).on("mousedown",x);
...
jQuery(H.labelElmtData.elmt).on("mousedown",D);
jQuery(H.impreciseTapeElmtData.elmt).on("mousedown",D);
if(F!=null){jQuery(H.iconElmtData.elmt).on("mousedown",D);
...
jQuery(H.labelElmtData.elmt).on("mousedown",D);
jQuery(H.tapeElmtData.elmt).on("mousedown",D);
if(F!=null){jQuery(H.iconElmtData.elmt).on("mousedown",D);
this._eventIdToElmt[I.getID()]=H.iconElmtData.elmt;
}else{this._eventIdToElmt[I.getID()]=H.labelElmtData.elmt;
}};
...
jQuery(B.elmt).on("mousedown",I);
jQuery(R.elmt).on("mousedown",I);
...
jQuery(C.elmt).on("mousedown",L);
jQuery(E.elmt).on("mousedown",L);
jQuery(V.elmt).on("mousedown",L);
...
jQuery(B.elmt).on("mousedown",G);
jQuery(S.elmt).on("mousedown",G);
...
jQuery(B.elmt).on("mousedown",K);
jQuery(U.elmt).on("mousedown",K);
...
jQuery(C.elmt).on("mousedown",M);
jQuery(E.elmt).on("mousedown",M);
jQuery(Y.elmt).on("mousedown",M);
...
jQuery(B.elmt).on("mousedown",J);
jQuery(V.elmt).on("mousedown",J);
...
jQuery(B.elmt).on("mousedown",L);
jQuery(a.elmt).on("mousedown",L);
...
jQuery(A).on("click",function(){window.location="http://code.google.com/p/simile-widgets/";
});
H.appendChild(A);
this._bands=[];
for(var B=0;
