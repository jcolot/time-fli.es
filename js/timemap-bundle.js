...
var
    ...
    // alias libraries
    $ = window.jQuery,
    LatLngPoint = google.maps.LatLng,
 ...
 * @param {LatLngPoint} [options.mapCenter=0,0] Point for map center
 * @param {Number} [options.mapZoom=0]          Initial map zoom level
 * @param {String} [options.mapTypeId=terrain]   The maptype for the map 
 ...
 * @param {Boolean} [options.mapTypeIdControl=true]  Whether to display the map type control
 * @param {Boolean} [options.zoomCtrl=true]      Whether to show map zoom control
 * @param {Boolean} [options.panCtrl=true]      Whether to show map zoom control
...
TimeMap = function(tElement, mElement, options) {
    ...
    if (mapCenter.constructor != LatLngPoint && mapCenter.lat) {
        options.mapCenter = new LatLngPoint(mapCenter.lat, mapCenter.lng);
    }
...
TimeMap.prototype = {
    ...
    initMap: function() {
        ...
        tm.map = map = new google.maps.Map(tm.mElement, mapOptions);
 ...
 * @param {LatLngPoint} [data.options.infoPoint]    Point indicating the center of this item
    ...
    showMarker: function() {
        ...
        var item = this,
            f = function(marker) {
                ...
                marker.cluster_.markerClusterer_.addMarker(marker);
...
/**
 * Make TimeMap.init()-style points from a GLatLng, LatLngPoint, array, or string
 *
 * @param {Object} coords       GLatLng, LatLngPoint, array, or string to convert
